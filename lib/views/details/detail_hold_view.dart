...
class CustomerHoldDetailView extends StatefulWidget {
  final Event? event;
  const CustomerHoldDetailView({Key? key, this.event}) : super(key: key);

  @override
  _CustomerHoldDetailViewState createState() => _CustomerHoldDetailViewState();
}

class _CustomerHoldDetailViewState extends State<CustomerHoldDetailView> {
  @override
